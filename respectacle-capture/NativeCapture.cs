...
{
    private const string DllName = "respectacle_capture";

    // ── S01 exports ──────────────────────────────────────────────────────

    [DllImport(DllName, CallingConvention = CallingConvention.Cdecl)]
    public static extern NativeCaptureResult respectacle_capture_frame();

    [DllImport(DllName, CallingConvention = CallingConvention.Cdecl)]
    public static extern void respectacle_free_frame(IntPtr data);

    [DllImport(DllName, CallingConvention = CallingConvention.Cdecl)]
    public static extern void respectacle_free_error_message(IntPtr msg);

    [DllImport(DllName, CallingConvention = CallingConvention.Cdecl)]
    public static extern void respectacle_free_capture_result(NativeCaptureResult result);
    ...
    /// </summary>
    [DllImport(DllName, CallingConvention = CallingConvention.Cdecl)]
    public static extern NativeCaptureResult respectacle_capture_all_monitors();
    ...
    /// </summary>
    [DllImport(DllName, CallingConvention = CallingConvention.Cdecl)]
    public static extern NativeCaptureResult respectacle_capture_monitor_by_index(uint index);
    ...
    /// </summary>
    [DllImport(DllName, CallingConvention = CallingConvention.Cdecl)]
    public static extern NativeCaptureResult respectacle_capture_active_window();
    ...
    /// </summary>
    [DllImport(DllName, CallingConvention = CallingConvention.Cdecl)]
    public static extern NativeCaptureResult respectacle_capture_window_under_cursor();
    ...
    /// </summary>
    [DllImport(DllName, CallingConvention = CallingConvention.Cdecl)]
    public static extern NativeCaptureResult respectacle_capture_window_by_handle(ulong hwnd);
    ...
    /// </summary>
    [DllImport(DllName, CallingConvention = CallingConvention.Cdecl)]
    public static extern NativeCaptureResult respectacle_capture_region(int x, int y, uint width, uint height);
}
...
public sealed class SafeCaptureResult : IDisposable
{
    ...
    /// </summary>
    /// <param name="native">The raw FFI result from a respectacle_capture_* function.</param>
    ...
    public SafeCaptureResult(NativeCaptureResult native)
    {
        ...
        finally
        {
            if (native.FrameData != IntPtr.Zero || native.ErrorMessage != IntPtr.Zero)
            {
                try
                {
                    NativeMethods.respectacle_free_capture_result(native);
                }
    ...
    public static SafeCaptureResult CapturePrimary()
    {
        ...
        try
        {
            native = NativeMethods.respectacle_capture_frame();
        }
    ...
    public static SafeCaptureResult CaptureMonitorByIndex(uint index)
    {
        ...
        try
        {
            native = NativeMethods.respectacle_capture_monitor_by_index(index);
        }
        catch (DllNotFoundException ex)
        {
            return FromInteropError("DLL not found", ex.Message);
    ...
    public static SafeCaptureResult CaptureAllMonitors()
    {
        ...
        try
        {
            native = NativeMethods.respectacle_capture_all_monitors();
        }
        catch (DllNotFoundException ex)
        {
            return FromInteropError("DLL not found", ex.Message);
    ...
    public static SafeCaptureResult CaptureActiveWindow()
    {
        ...
        try
        {
            native = NativeMethods.respectacle_capture_active_window();
        }
        catch (DllNotFoundException ex)
        {
            return FromInteropError("DLL not found", ex.Message);
    ...
    public static SafeCaptureResult CaptureWindowUnderCursor()
    {
        ...
        try
        {
            native = NativeMethods.respectacle_capture_window_under_cursor();
        }
        catch (DllNotFoundException ex)
        {
            return FromInteropError("DLL not found", ex.Message);
    ...
    public static SafeCaptureResult CaptureWindowByHandle(IntPtr hwnd)
    {
        ...
        try
        {
            native = NativeMethods.respectacle_capture_window_by_handle((ulong)hwnd.ToInt64());
        }
        catch (DllNotFoundException ex)
        {
            return FromInteropError("DLL not found", ex.Message);
    ...
    public static SafeCaptureResult CaptureRegion(int x, int y, uint width, uint height)
    {
        ...
        try
        {
            native = NativeMethods.respectacle_capture_region(x, y, width, height);
        }
        catch (DllNotFoundException ex)
        {
            return FromInteropError("DLL not found", ex.Message);

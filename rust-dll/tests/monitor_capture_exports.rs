...
//! - The new exports `respectacle_capture_monitor_by_index` and `respectacle_capture_all_monitors`
...
#[test]
fn respectacle_capture_monitor_by_index_exists() {
    ...
    let _fn_ptr: extern "C" fn(u32) -> CaptureResult =
        respectacle_capture_monitor_by_index;
}

#[test]
fn respectacle_capture_all_monitors_exists() {
    let _fn_ptr: extern "C" fn() -> CaptureResult =
        respectacle_capture_all_monitors;
}
...
fn monitor_by_index_zero_captures_primary() {
    ...
    let result = respectacle_capture_monitor_by_index(0);
...
fn monitor_by_index_very_large_returns_error() {
    let result = respectacle_capture_monitor_by_index(999999);
...
fn capture_all_monitors_error_has_sane_metadata() {
    ...
    let result = respectacle_capture_all_monitors();

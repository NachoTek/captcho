...
public static class CliParser
{
    ...
    public static string BuildHelpText()
    {
        ...
        sb.AppendLine("captcho CLI — Headless screen capture for Windows");
        sb.AppendLine();
        sb.AppendLine("Usage: captcho-cli <mode> [options]");
        sb.AppendLine();
        ...
        sb.AppendLine("                                 Default: %USERPROFILE%\\Pictures\\captcho\\");
        sb.AppendLine("  --filename <template>          Filename template with placeholders:");
        sb.AppendLine("                                 <yyyy> <MM> <dd> <hh> <mm> <ss> <#>");
        sb.AppendLine("                                 Default: captcho_<yyyy>-<MM>-<dd>_<hh><mm><ss>.png");
        sb.AppendLine();
